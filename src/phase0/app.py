...
def recommend():
    ...
    # Phase 0: Render results page with submitted preferences
    # Phase 3+: This will include actual LLM-generated recommendations
    return render_template("results.html", preferences=validated, recommendations=None)
